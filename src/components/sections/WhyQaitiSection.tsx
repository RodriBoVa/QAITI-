...
const reasons = [
  { num: "01", title: "Students Need AI-Era Readiness",           desc: "Students need the knowledge, skills, mindset, and human capabilities to thrive in an AI-powered world." },
  { num: "02", title: "Teachers Need Structured Support",         desc: "Teachers need practical training, tools, and ongoing enablement to confidently deliver AI-era learning." },
  { num: "03", title: "Human Skills Are Becoming More Important", desc: "Critical thinking, creativity, ethics, communication, and resilience are the differentiators in the age of AI." },
  { num: "04", title: "Nations Need Future-Ready Talent",         desc: "Nations that invest in human capability today will lead in innovation, productivity, and global competitiveness." },
  { num: "05", title: "Schools Need a Practical Model",           desc: "Schools need an integrated, scalable, and sustainable model that is easy to adopt and designed for impact." },
];
...
export default function WhyQaitiSection() {
  ...
  return (
    <section ref={ref} className="relative py-32" style={{ background: "#F5F0E8", overflow: "hidden" }}>
      <div className="section-inner">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          {reasons.map((r, i) => (
            <ScrollRevealItem key={r.num} progress={scrollYProgress} index={i}
              baseStart={0.44} step={0.045} direction="up" distance={36} fadeOut={false}>
              <motion.div
        ...
        <ScrollReveal progress={scrollYProgress} start={0.72} end={0.82} direction="up" fadeOut={false}>
          <div className="mt-12 p-7 border text-center" style={{ background: "rgba(255,255,255,0.55)", borderColor: "rgba(184,150,46,0.15)" }}>
